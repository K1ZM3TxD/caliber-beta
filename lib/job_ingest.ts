      ...
      rulesByLevel: [
        ...
        },
        {
          ...
          patterns: [
            ...
            /\b(multi[- ]?site|multi[- ]?location)\b/i,
            /\b(national|nationwide|regional)\b/i,
            /\b(branch (management|team|network)|branch(es)?)\b/i,
            /\b(thousands? of employees|\d{4}\+? employees)\b/i,
          ],
        },
        {
          level: 2,
          patterns: [
            /\b(enterprise|global organization)\b/i,
      ...
      rulesByLevel: [
        {
          ...
          patterns: [
            ...
            /\b(is responsible for|responsible for)\b/i,
            /\b(what you('|')?ll be doing|what you will be doing)\b/i,
            /\b(duties and functions)\b/i,
          ],
        },
        {
          level: 1,
        ...
        },
        {
          ...
          patterns: [
            ...
            /\b(additional duties)\b/i,
            /\b(as required|as needed)\b/i,
          ],
        },
      ],
    },
      ...
      rulesByLevel: [
        ...
        },
        {
          ...
          patterns: [
            ...
            /\b(portfolio|product portfolio)\b/i,
            /\b(product line(s)?|assigned product line(s)?)\b/i,
            /\b(territory|assigned territory)\b/i,
            /\b(account[- ]?specific)\b/i,
            /\b(vertical markets?)\b/i,
            /\b(cross[- ]?sell|upsell|up[- ]?sell)\b/i,
          ],
        },
      ],
    },
