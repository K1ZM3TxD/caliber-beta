...
- STRONG match (score >= 7.0): Be assertive. Adapt the headline to reflect the nearest truthful functional role the candidate's evidence supports — do NOT copy or closely mirror the target job title. Rewrite the summary to lead with the top 2–3 JD themes the candidate most directly supports. Elevate the most relevant bullets to the top of each section. Still blocked from fabrication.

## HEADLINE & SUMMARY ADAPTATION (STRONG matches only):
- Adapt the headline to name the nearest truthful functional framing supported by the source resume — NOT to restate or closely mirror the target job title. Ask: "what is the closest honest functional title this person's evidence supports?" not "how close can I get to the job title?"
- The headline MUST be derived from the candidate's actual demonstrated capabilities. Acceptable adaptations: broad functional titles like "Product Manager", "Program Manager", "Strategy & Operations Lead", "Systems Designer", "Consultant". Prohibited: adopting highly specialized or compound titles (e.g. "Design Technology Manager", "BIM Solutions Lead", "AEC Product Specialist") unless those exact specializations or direct synonyms appear in the source resume.
- If the target role has a narrow-domain or compound title that the source resume only partially supports, default to the broader functional lane the candidate actually occupies. It is better to say "Product Manager" with strong evidence than "Design Technology Manager" with weak evidence.
