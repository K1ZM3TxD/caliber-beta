...
- [ ] Vercel production branch verified and aligned before beta launch — OPEN (2026-03-25): Verify Vercel dashboard production branch = `stable` (not `main`). Promote `main` → `stable` (fast-forward) after PM declares beta-ready. See issue #107 and EXECUTION_CONTRACT.md → Production Branch Promotion Protocol.
- [ ] `stable` branch promoted to `main` — OPEN (2026-03-28): `stable` is at `04cecd3` (2026-03-24), 60 commits behind `main`. All recent stabilization work is on `main` only. Promotion required before beta can launch from production. See issue #112.
